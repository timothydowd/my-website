      ...
      <div className='work-container' id='work'>
        ...
        <div className='work-text-container'>
          ...
          <div>
            ...
            <div>
              - Reserv3d - a table booking mobile application where users can view a restaurant in 360/VR, and book an available table.  The projects front end was built in React 360 for the virtual environment, React Native for the mobile functionaility and backend in Node, Express and SQL.  This was a team project where I worked mostly on the virtual environment in React 360.

      ...
      <div className='about-container' id='about'>
        ...
        <h1>About</h1>
          ...
          <p className='about-text'>
            ...
            little deeper intot the world of code..  I started studying Ruby and a few months 
          ...
          <p className='about-text'>
            Being a very visual person, my passion tends to lean towards front end.
          </p>

          <p className='about-text'>
            In my spare time you can find me playing around in Photoshop and Illustrator, making
            awful music in Ableton, running around the streets of Manchester trying to keep fit
            or doing the occasional lightning talk.  But most likely you will find me playing 
            Apex Legends
          </p>
